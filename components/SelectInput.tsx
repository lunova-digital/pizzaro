...
export const SelectInput: FC<SelectInputProps> = ({
	...
	return (
		<div ref={selectRef} className='w-[170px] relative'>
			{/* Button */}
			<button
				type='button'
				onClick={() => setOpen((prev) => !prev)}
				className={`${selected === 'Not-Available' ? '!bg-red-500 !text-white' : ''} w-full flex justify-between items-center bg-white border border-gray-300 rounded-xl px-4 py-1 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition `}
				disabled={isUpdating}
			>
