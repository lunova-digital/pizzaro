...
export default function FeaturedCombos() {
	...
	return (
		<section
			className='py-16 md:py-24 bg-gradient-to-br from-red-50 via-bg to-orange-50 relative overflow-hidden'
			id='combos'
		>
			...
			<div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10'>
				<div className='text-center mb-14'>
					...
					<h2
						className='text-4xl sm:text-5xl font-black text-dark tracking-tight leading-tight'
							...
							<div className='p-6 flex flex-col flex-1 gap-4'>
								<div>
									<h3 className='font-bold text-2xl text-dark group-hover:text-primary transition-colors'>
										{lang === 'bn' && combo.name_bn
											? combo.name_bn
											: combo.name}
									</h3>
									<p className='text-gray-500 text-sm mt-2 line-clamp-2 leading-relaxed'>
										{lang === 'bn' && combo.description_bn
